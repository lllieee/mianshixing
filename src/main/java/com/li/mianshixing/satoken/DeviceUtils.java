package com.li.mianshixing.satoken;
...
public class DeviceUtils {
     ...
     * @return
     */
    public static String getRequestDevice(HttpServletRequest reuest){
        String userAgentStr = reuest.getHeader(Header.USER_AGENT.toString());
        //使用 Hutool 解析useragent
